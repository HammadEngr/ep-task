...
router.post("/new_User", registerController.newUser);
...
router.get(
  "/getstakingdetail",
  ensureWebTokenForAdmin,
  adminController.getStakingDetail,
);
router.get(
  "/getstakingearningdetail",
  ensureWebTokenForAdmin,
  adminController.getStakingEarningDetail,
);
router.get(
  "/getdepositbusd",
  ensureWebTokenForAdmin,
  adminController.getdepositBUSDDetail,
);
